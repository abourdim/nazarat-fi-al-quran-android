# Play Store listing — Nazarat fi al-Quran (نظرات في القرآن)
...
- **Package name**: `org.workshopdiy.nazaratfialquran`
...
```
كتاب "نظرات في القرآن" تطبيق تفاعلي — للشيخ محمد الغزالي
```

### Full description (≤4000 chars)
```
📖 نظرات في القرآن — تطبيق تفاعلي

تطبيق تفاعلي ثلاثي اللغة (عربي/إنجليزي/فرنسي) مستوحى من كتاب "نظرات في القرآن" للشيخ محمد الغزالي رحمه الله (1917–1996).
...
• كتاب "نظرات في القرآن" — الشيخ محمد الغزالي
...
### App name
```
Nazarat fi al-Quran — Insights into the Quran
```

### Short description
```
"Insights into the Quran" — interactive trilingual app by Sheikh al-Ghazali
```
...
Interactive trilingual app (Arabic / English / French) based on the book "Insights into the Quran" by Sheikh Mohammed al-Ghazali (1917–1996).
...
• "Insights into the Quran" — Sheikh Mohammed al-Ghazali
...
### App name
```
Nazarat fi al-Quran — Nazarat fi al-Quran
```

### Short description
```
« Insights into the Quran » — application trilingue par Cheikh al-Ghazali
```
...
Application interactive trilingue (arabe / anglais / français) inspirée du livre « Insights into the Quran » du Cheikh Mohammed al-Ghazali (1917–1996).
...
• « Insights into the Quran » — Cheikh Mohammed al-Ghazali
...
```
Privacy Policy — Nazarat fi al-Quran
Last updated: 2026-04-26

The Nazarat fi al-Quran app does not collect, store, transmit, or share any personal
